...
class AuthController extends GetxController implements GetxService {
  ...
  void initCountryCode({String? countryCode}){
    print("Get.find<SplashController>().configModel!.country");
    print(Get.find<SplashController>().configModel!.country);
    countryDialCode = countryCode ?? CountryCode.fromCountryCode(Get.find<SplashController>().configModel!.country ?? "BD").dialCode ?? "+20";
  }
