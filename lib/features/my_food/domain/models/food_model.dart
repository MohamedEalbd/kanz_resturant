class FoodsModel {
  ...
  @override
  String toString(){
    return "$id, $name, $description, $image, $categoryId, $categoryIds, $variations, $addOns, $attributes, $choiceOptions, $price, $tax, $taxType, $discount, $discountType, $availableTimeStarts, $availableTimeEnds, $veg, $status, $restaurantId, $createdAt, $updatedAt, $orderCount, $avgRating, $ratingCount, $recommended, $slug, $maximumCartQuantity, $isHalal, $itemStock, $sellCount, $stockType, $tags, $restaurantName, $restaurantStatus, $restaurantDiscount, $restaurantOpeningTime, $restaurantClosingTime, $scheduleOrder, $minDeliveryTime, $maxDeliveryTime, $freeDelivery, $halalTagStatus, $nutritionsName, $allergiesName, $cuisines, $imageFullUrl, $translations, $newVariations, $nutritions, $allergies, $storage, ";
  }
}
