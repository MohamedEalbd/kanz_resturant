...
import 'package:stackfood_multivendor/features/my_food/domain/models/food_nearly_model.dart';

import '../../../common/models/restaurant_model.dart';
import '../../../common/widgets/bottom_cart_widget.dart';
...
class FoodDetailsScreen extends StatefulWidget {
  ...
  const FoodDetailsScreen({super.key,  this.foodsModel, this.foodNearly});
            ...
            children: [
              FractionallySizedBox(
                ...
                child: CustomImageWidget(
                  ...
                  height: 400.h,fit: BoxFit.cover,
                ),
              ),
              Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [

                Text(
                    widget.foodsModel!.name ?? '', style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w600),
                    maxLines: 1, overflow: TextOverflow.ellipsis
                ),

                Text(
                  "${widget.foodsModel!.price} ${"sar".tr}" ,
             ...
             SizedBox(height: 5.h),
              Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                ...
                Text(
                    "(${"remaining".tr} ${widget.foodsModel!.sellCount})", style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w400,color: Color(0xff7C0631)),
                    maxLines: 1, overflow: TextOverflow.ellipsis
                ),

                Text(
                  "${widget.foodsModel!.discount} ${"sar".tr}" ,
                  style: robotoRegular.copyWith(fontSize: 12.sp, color: Theme.of(context).hintColor,decoration: TextDecoration.lineThrough),
                  maxLines: 1, overflow: TextOverflow.ellipsis,
                ),
              ]),
              SizedBox(height: 5.h),
              Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                ...
                (widget.foodsModel!.ratingCount == 1 ) ?   Container(
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text('${widget.foodsModel!.avgRating?.toStringAsFixed(1)}', style: robotoBold.copyWith(color: Theme.of(context).cardColor,fontSize: 20.sp)) : const SizedBox(),
                            SizedBox(width: widget.foodsModel!.ratingCount == 1 ? 5 : 0),
                            widget.foodsModel!.ratingCount == 1 ? Icon(Icons.star, color: Theme.of(context).cardColor, size: 15) : const SizedBox(),
                          ],
                        ),
                      )
                    ],
                ...
                //     Text(
                //         '', style: robotoMedium.copyWith(fontSize: 15.sp, fontWeight: FontWeight.w300),
                //         maxLines: 1, overflow: TextOverflow.ellipsis
                //     ),
                    ...
                    builder: (cartController) {
                      final product = Product(
                       ...
                       // categoryIds: widget.foodsModel!.categoryIds as List<CategoryIds>? ,
                        ...
                        availableTimeStarts: widget.foodsModel!.availableTimeStarts,
                        availableTimeEnds: widget.foodsModel!.availableTimeEnds,
                        restaurantId: widget.foodsModel!.restaurantId,
                        restaurantName: widget.foodsModel!.restaurantName,
                        restaurantDiscount: widget.foodsModel!.restaurantDiscount!.toDouble(),
                        ...
                        cartQuantityLimit: widget.foodsModel!.maximumCartQuantity,
                        isRestaurantHalalActive:  widget.foodsModel!.isHalal ==1,
                      ...
                      int cartQty = cartController.cartQuantity( widget.foodsModel!.id!);
                      int cartIndex = cartController.isExistInCart( widget.foodsModel!.id, null);
                      CartModel cartModel = CartModel(
                        null, price, discountPrice, (price - discountPrice),
                        1, [], [], false,  product, [],  widget.foodsModel!.maximumCartQuantity,[],
                      );
                      return cartQty != 0 ? Container(
                        ...
                        child: Container(
                          ...
                          child: Icon(Icons.add, size: 25, color: Theme.of(context).primaryColor),
                        ),
                      );
                    }
                )
                ...
                child: Row(
                  children: [
                    Column(
                      ...
                      children: [
                        Text(
                            "Restaurant_and_branch".tr , style: robotoMedium.copyWith(fontSize: 15.sp, fontWeight: FontWeight.w300),
                            maxLines: 1, overflow: TextOverflow.ellipsis
                        ),
                        Text(
                            widget.foodsModel!.restaurantName! ??"" , style: robotoMedium.copyWith(fontSize: 15.sp, fontWeight: FontWeight.w300),
                            maxLines: 1, overflow: TextOverflow.ellipsis
                        ),
                        Text(
                           "" , style: robotoMedium.copyWith(fontSize: 15.sp, fontWeight: FontWeight.w300),
                ...
                children: [
                  Container(
                    ...
                    child:  GetBuilder<FavouriteController>(builder: (favouriteController) {
                      bool isWished = favouriteController.wishRestIdList.contains(widget.foodsModel!.restaurantId);
                 ...
                 Expanded(child: BuildButtonWidget(txt: "add_to_cart".tr,onTap: ()async{
